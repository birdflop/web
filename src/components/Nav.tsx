    ...
    <nav class="z-20 fixed top-0 w-screen my-3 pointer-events-none drop-shadow-lg">
      <div class="mx-auto max-w-7xl px-4 lg:px-6">
        <div class="relative flex h-16 items-center justify-between">
          ...
          <div class="flex flex-1 items-center justify-end">
            <div class="pointer-events-auto flex gap-2 text-gray-300 whitespace-nowrap">
              <button class="cursor-pointer transition duration-200 ease-in-out hidden sm:flex bg-gray-900 hover:bg-gray-800 hover:text-white hover:drop-shadow-2xl border-2 border-gray-900 hover:border-gray-700 group rounded-lg text-md items-center gap-4">
                ...
                <div class="absolute top-0 left-0 z-10 hidden group-hover:flex pt-16">
                  <div class="bg-black/50 rounded-xl px-3 py-4 flex flex-col space-y-2 font-medium whitespace-nowrap overflow-y-auto max-h-[calc(100svh-128px)]">
                    ...
                    <Link href="/Presets" class="transition duration-200 ease-in-out bg-gray-900 hover:bg-gray-800 hover:text-white hover:drop-shadow-2xl border-2 border-gray-900 hover:border-gray-700 px-4 py-2 rounded-lg text-md flex items-center gap-4">
                      Presets
                    </Link>
                  </div>
                </div>
              ...
              <Link href="/AnimTexture" class="transition duration-200 ease-in-out hidden bg-gray-900 hover:bg-gray-800 hover:text-white hover:drop-shadow-2xl border-2 border-gray-900 hover:border-gray-700 px-4 py-2 rounded-lg text-md md:flex items-center gap-4">
                Animated Textures
              </Link>
              <Link href="/MiscTools" class="transition duration-200 ease-in-out hidden bg-gray-900 hover:bg-gray-800 hover:text-white hover:drop-shadow-2xl border-2 border-gray-900 hover:border-gray-700 px-4 py-2 rounded-lg text-md lg:flex items-center gap-4">
                Misc Tools
              </Link>
        ...
        <div id="mobile-menu" class="pointer-events-auto space-y-4 py-4 px-3 justify-center items-center bg-black/50 rounded-lg mt-2 hidden">
          ...
          <Link href="/Presets" class="transition duration-200 ease-in-out bg-gray-900 hover:bg-gray-800 hover:text-white hover:drop-shadow-2xl border-2 border-gray-900 hover:border-gray-700 px-4 py-2 rounded-lg text-md flex sm:hidden items-center gap-4">
            Gradient Presets
          </Link>
