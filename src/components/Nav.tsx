...
export default component$(() => {
  ...
  return (
    <Nav fixed>
      ...
      <DropdownRaw id="nav-serverlist" q:slot='end' size="md" color="transparent" hover
        display={<div class="flex items-center gap-3"><ServerOutline width={24} />Server List</div>}
        class={{ 'hidden sm:flex': true }}>
        <ButtonAnchor q:slot="extra-buttons" color="transparent" href="https://panel.birdflop.com/">
          Panel
        </ButtonAnchor>
