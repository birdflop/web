...
export const RawOutputField = component$(({ id, value, charlimit, extraClass }: any) => {
  ...
  return <>
    <textarea disabled class={`transition ease-in-out cursor-pointer bg-gray-800 text-gray-50 hover:bg-gray-700 focus:bg-gray-700 rounded-md px-3 py-2 break-words ${extraClass}`} id={id} value={value} onClick$={(event: any) => {
