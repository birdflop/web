...
export default component$(({ extraClass }: any) => {
  return (
    <svg xml:space="preserve" class={extraClass} fill-rule="evenodd" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="1.5" clip-rule="evenodd" viewBox="0 0 24 24">
      ...
      <path fill="none" stroke="currentColor" stroke-width="1.68" d="m264 41.95 8-4v8l-8 4v-8Z" transform="matrix(1.125 0 0 1.2569 -285 -40.78)"></path>
      <path fill="none" stroke="currentColor" stroke-width="1.68" d="m264 41.95 8-4v8l-8 4v-8Z" transform="matrix(-1.125 0 0 1.2569 309 -40.78)"></path>
    </svg>
