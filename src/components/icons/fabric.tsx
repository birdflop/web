...
export default component$(({ extraClass }: any) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" class={extraClass} xml:space="preserve" fill-rule="evenodd" stroke-linecap="round" stroke-linejoin="round" clip-rule="evenodd" viewBox="0 0 24 24">
