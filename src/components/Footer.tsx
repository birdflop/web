  ...
  return (
    <footer class="relative flex flex-col gap-6 items-center justify-center w-full h-24 z-10 bg-gray-950/40 py-24">
      ...
      <span class="text-sm text-gray-300 max-w-6xl text-center">
        ...
        By using this site, you agree to our <a href="/terms" class="text-blue-400 hover:underline">terms of service</a> and <a href="/privacy" class="text-blue-400 hover:underline">privacy policy</a>. Items marked with an asterisk (*) are a reminder that our fair use policy outlined in our terms applies.
      </span>
    </footer>
  );
});