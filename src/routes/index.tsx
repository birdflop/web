    ...
    <section class="flex mx-auto max-w-7xl px-6 items-center justify-center min-h-[calc(100lvh-68px)]">
      <picture class="fixed top-0 overflow-hidden" style={{ height: '100lvh', width: '100lvw' }}>
        <img
          ...
          height={1080}
          src={background}
          class="object-cover object-center h-full w-full opacity-50 blur-md"
        ...
        <div id="noise" class="flex relative justify-center align-center">
          ...
          <div class="mt-10 space-y-3 min-h-[60px]">
            ...
            <h2 class="text-gray-300 text-2xl mb-12 fade-in animation-delay-100">
              A nonprofit dedicated to <span class="typer" id="main" data-words={'minecraft hosting,public resources,communities,you'} data-colors="#6366f1,#3b82f6,#6d28d9,#6e6abb" data-delay="50" data-deleteDelay="1000"></span>
              <span class="cursor" data-owner="main" data-cursor-display="|"></span>
            </h2>
            <div class="flex justify-center fade-in animation-delay-100">
              <a href="https://www.paypal.com/donate/?hosted_button_id=6NJAD4KW8V28U" class="mr-4 flex transition ease-in-out rounded-xl shadow-lg backdrop-blur-lg bg-gradient-to-b from-sky-900/80 to-sky-700/80 hover:bg-sky-700 px-6 py-3 text-pink-100 md:py-4 md:px-8 mt-10 text-sm md:text-lg whitespace-nowrap gap-5 items-center">
                <ServerOutline width="30" class="text-3xl" /> Hosting
              </a>
              <a href="https://www.paypal.com/donate/?hosted_button_id=6NJAD4KW8V28U" class="flex transition ease-in-out rounded-xl shadow-lg backdrop-blur-lg bg-gradient-to-b from-pink-900/80 to-pink-700/80 hover:bg-pink-700 px-6 py-3 text-pink-100 md:py-4 md:px-8 mt-10 text-sm md:text-lg whitespace-nowrap gap-5 items-center">
