...
export const themes = {
  ...
  white: {
    ...
    '--color-nav-bg': 'color-mix(in oklab, var(--color-white), transparent 5%)',
    '--color-green': 'var(--color-green-500)',
    '--color-red': 'var(--color-red-500)',
    '--color-orange': 'var(--color-orange-500)',
    '--color-yellow': 'var(--color-yellow-500)',
    ...
    '--color-lime': 'var(--color-lime-500)',
    '--color-teal': 'var(--color-teal-500)',
    '--color-lum-border': 'var(--color-neutral-600)',
    '--color-lum-card-bg': 'var(--color-neutral-100)',
    '--color-lum-input-bg': 'var(--color-neutral-200)',
    '--color-lum-input-hover-bg': 'var(--color-neutral-200)',
    '--color-lum-accent': 'var(--color-blue-200)',
    '--color-lum-text': 'var(--color-neutral-900)',
    '--color-lum-text-secondary': 'var(--color-neutral-800)',
    '--lum-default-alpha': '70',
    '--lum-border-radius': '0.625rem',
  },
};
